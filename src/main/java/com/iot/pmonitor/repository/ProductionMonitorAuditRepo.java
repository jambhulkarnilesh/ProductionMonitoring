...
public interface ProductionMonitorAuditRepo extends JpaRepository<ProductionMonitorAudit, Integer> {
    ...
    public List<Object[]> getAllProductionMonitor(String fromDate, String toDate, Integer machineId, String machineName, String machinePLCType, Integer partId, String partName, String machTargetJobCount, String machCompletedJobCount, String machineStatus, String machJobStatus, String sortName, Integer pageSize, Integer pageOffset);
